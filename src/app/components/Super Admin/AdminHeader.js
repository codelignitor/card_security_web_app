...
const PageHeader = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-slate-700 text-white px-4 sm:px-6 py-3 sm:py-4 shadow-lg z-50">
        ...
        <div className="hidden sm:flex items-center space-x-4 lg:space-x-6">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <button 
              ...
              className="text-blue-300 hover:text-blue-200 text-sm px-2 sm:px-3 py-1 rounded-lg hover:bg-slate-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400"
            >
      ...
      {mobileMenuOpen && (
        <div className="sm:hidden absolute top-full left-0 right-0 bg-slate-700 border-t border-slate-600 shadow-lg">
